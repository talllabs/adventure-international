  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <FadeInUp>
          <p className="text-lg text-charcoal-soft leading-relaxed">{brand.description}</p>
      ...
      {brand.sections.map((section, idx) => (
        <div
          key={idx}
          className={`${idx % 2 === 0 ? "bg-ivory" : "bg-ivory-warm"} py-20`}
        >
          <div
          ...
          >
            ...
            <FadeInUp delay={0.15}>
              ...
              <h2 className="font-serif text-4xl md:text-5xl text-forest font-light mb-6">{section.headline}</h2>
              <p className="text-charcoal-soft leading-relaxed text-lg">{section.body}</p>
            </FadeInUp>
          </div>
        </div>
      ))}
